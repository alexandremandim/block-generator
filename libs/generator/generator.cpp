...
int Generator::loadModels(){
    ...
    std::cout << "Creating  " << nr_models << "  model(s)..." << endl;
    ...
    std::cout << "Models created with success." << endl << endl;            
    return 1;
}
...
tuple<double, double> Generator::get_media_inter(int percentage_interval){
    ...
    std::cout << "Compression interval estimated based on " << nr_pairs << " pairs of block." << endl;
...
int Generator::initialize() {
    ...
    std::cout << "File readed with success." << endl << endl;
    std::cout << "File readed with success." << endl << endl;
    ...
    std::cout << "Total blocks:\t" << globalArgs.blocosAGerar << endl;
    std::cout << "Unique blocks:\t" << globalArgs.total_unique_blocks << endl << endl;

    /* Calcular o intervalo esperado de compressão entre blocos*/
    //std::cout << "Estimating interval of compression between two blocks" << endl;
    compressions_inter_blocks_interval = get_media_inter(globalArgs.percentage_unique_blocks_analyze);
    std::cout << "Estimated Compression Interval: [" << get<0>(compressions_inter_blocks_interval) 
